...
import (
	...
	tcore "github.com/dnerochain/dnero/core"
...
type DneroGetBlockResult struct {
	*DneroGetBlockResultInner
}
type DneroGetBlocksResult []*DneroGetBlockResultInner

type DneroGetBlockResultInner struct {
