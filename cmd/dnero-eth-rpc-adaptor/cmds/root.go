...
var RootCmd = &cobra.Command{
	Use:   "dnero-eth-rpc-adaptor",
	Short: "Dnero ETH RPC Adaptor",
	Long:  `Dnero ETH RPC Adaptor`,
}
...
func getDefaultConfigPath() string {
	...
	return path.Join(home, ".dnero-eth-rpc-adaptor")
}
...
// The privatenet environment has the following 10 test accounts preloaded with DToken in the genesis
